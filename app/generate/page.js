...
export default function Home() {
    ...
    const {
        ...
        defaultValues: {
            treeName: searchParams.get("tree"),
            profilePicture: "",
    ...
    const onSubmit = async (data) => {
        ...
        if (result.success) {
            console.log("Sucess")
            alert("Your linktree has been made sucessfully!")
            redirect(`${process.env.NEXT_PUBLIC_HOST}/${data.treeName}`) // Redirect to the tree page
